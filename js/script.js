	...
	**/
	...
	var chart = {
		...
		getPercentData : function(){
			var aPercent = [50, 100, 100, 50, 100, 100],
	...
	var checkParam = {
		...
		changeClass : function(){
			...
			/*if(Base64.decode(oApplyName.en) === 'kakao'){
				$('body').addClass(Base64.decode(oApplyName.en));
			}*/
		}
	};
